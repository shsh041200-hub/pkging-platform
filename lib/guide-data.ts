...
export const GUIDE_META: GuideMeta[] = [
  {
    slug: "label-printing-guide",
    title: "라벨 인쇄 업체 선정 가이드",
    description:
      "인쇄 방식(디지털·옵셋·플렉소), 소재, MOQ, 납기 기준을 항목별로 비교합니다.",
  },
  {
    slug: "flexible-packaging-guide",
    title: "연포장재 완전 가이드 — 종류·소재·선택 기준",
    description:
      "파우치·롤 필름·합지 소재 비교, 식품 안전 기준(OTR·WVTR), MOQ·납기, 업체 선택 체크리스트를 정리합니다.",
  },
  {
    slug: "plastic-container-guide",
    title: "플라스틱 용기·병 종류 완전 가이드 — PET·PP·HDPE 소재 선택 + 식약처 기준",
    description:
      "PET·PP·HDPE·PS·PC 소재 비교, 식품용 식약처 이행성 시험 기준, 사출·블로우·진공 성형 공법 차이, 금형비·MOQ·친환경 rPET 비용을 정리합니다.",
  },
  {
    slug: "plastic-containers-guide",
    title: "플라스틱 용기·병 완전 가이드 — 종류·소재·업체 선택 기준 (2026년)",
    description:
      "플라스틱 용기·병 종류·소재·식품 안전 기준·업체 선택 체크리스트를 한 곳에 정리했습니다. PET 병, PE·PP·HDPE 용기 비교와 Packlinx 플라스틱 용기 업체 디렉토리.",
  },
  {
    slug: "packaging-printing-guide",
    title: "포장 인쇄 종류·후가공 완전 가이드 — 옵셋·플렉소·그라비어·디지털 비교",
    description:
      "포장 인쇄 방식(옵셋·플렉소·그라비어·디지털) 비교, 코팅·박·엠보싱 등 후가공 종류, 식품 인쇄 잉크 규제, 파일 규격 체크리스트를 정리합니다.",
  },
  {
    slug: "glass-metal-container-guide",
    title: "유리·금속 용기 완전 가이드 — 종류·소재·MOQ·인쇄 옵션 비교 (2026)",
    description:
      "유리 용기(갈색·투명·청색, 병·단지·바이알)와 금속 캔(알루미늄·TFS·양철) 종류 비교, 식품·화장품·의약품별 선택 기준, B2B 구매 결정 비교표, MOQ·커스텀 성형 비용, 슈링크 라벨·직접 인쇄 옵션을 정리합니다.",
  },
  {
    slug: "packaging-accessories-guide",
  ...
  },
  {
    ...
    title: "식품 포장재 소재 가이드",
    description:
      "식품 포장에 적합한 소재 선택 기준과 위생·규제 요건을 정리합니다.",
  },
  {
    slug: "eco-friendly-packaging",
    title: "친환경 포장재 가이드",
    description:
      "FSC 인증, 생분해 필름, 재생 PET 등 친환경 포장재 전환 기준과 ESG 활용법을 정리합니다.",
  },
  {
    slug: "small-quantity-custom-box",
    title: "소량 맞춤 박스 제작 가이드",
    description:
      "100개부터 가능한 소량 맞춤 박스 디지털 인쇄 방식, 단가, 납기, 파일 준비 방법을 안내합니다.",
  },
  {
    slug: "corrugated-flute-types",
    title: "골판지 플루트 유형 가이드",
    description:
      "A·B·C·E·F 플루트별 특성과 박스 설계 시 적합한 용도를 안내합니다.",
  },
  {
    slug: "corrugated-box-supplier-selection",
    title: "골판지 박스 업체 선정 가이드",
    description:
      "MOQ·납기·인쇄 방식·인증 기준으로 골판지 박스 업체를 비교 선정하는 방법을 정리합니다.",
  },
  {
  ...
  {
    slug: "electronics-packaging-design",
  ...
  {
    slug: "packaging-machinery-guide",
