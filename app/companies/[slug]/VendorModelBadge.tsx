    ...
    <div className="inline-flex items-center gap-1.5">
      ...
      <div className="relative group">
        <button
          ...
          className="w-4 h-4 rounded-full bg-neutral-200 hover:bg-neutral-300 text-neutral-500 flex items-center justify-center text-[9px] font-bold transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[#533afd]"
        >
          i
        </button>
        <div
