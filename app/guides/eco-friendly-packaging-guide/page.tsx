...
const faqJsonLd = {
  ...
  mainEntity: [
    ...
    {
      "@type": "Question",
      name: "GR 인증과 환경부 재활용 용이성 등급은 어떻게 다른가요?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "GR 인증(Good Recycled)은 한국환경산업기술원이 재활용 원료 함량·품질을 확인하는 인증으로, 재생 원료 사용 제품에 부여됩니다. 환경부 재활용 용이성 등급은 포장재의 구조·재질이 재활용 공정에서 얼마나 쉽게 처리되는지를 최우수~재활용 불가 4단계로 분류하며, 등급이 낮을수록 EPR 분담금이 가중됩니다. 두 제도는 목적이 다르므로 공급 업체에 두 가지 서류를 모두 요청하십시오.",
      },
    },
  ],
};
...
const slotFaq = [
  ...
  {
    question: "국내 친환경 포장재 업체는 어떻게 탐색하나요?",
    answer: "Packlinx 벤더 디렉토리에서 소재(생분해·재활용·바이오기반), GR 인증 여부, MOQ 기준, 업종 특화 여부로 필터링하여 적합한 공급 업체를 비교할 수 있습니다. <a href=\"/categories/eco-friendly-packaging\">친환경 포장재 업체 지금 비교 →</a>",
  },
  {
    question: "GR 인증과 환경부 재활용 용이성 등급은 어떻게 다른가요?",
    answer: "GR 인증(Good Recycled)은 한국환경산업기술원이 재활용 원료 함량·품질을 확인하는 인증으로, 재생 원료 사용 제품에 부여됩니다. 환경부 재활용 용이성 등급은 포장재의 구조·재질이 재활용 공정에서 얼마나 쉽게 처리되는지를 최우수~재활용 불가 4단계로 분류하며, 등급이 낮을수록 EPR 분담금이 가중됩니다. 두 제도는 목적이 다르므로 공급 업체에 두 가지 서류를 모두 요청하십시오.",
  },
];
