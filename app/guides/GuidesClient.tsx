...
export function GuidesClient({ totalGuides }: { totalGuides: number }) {
  ...
  return (
    <div className="-mx-5 sm:-mx-8 -mt-10 sm:-mt-14">
      ...
      <main className="max-w-[1180px] mx-auto px-6 pb-8">
        {isFiltering ? (
          <FilteredResults guides={filtered} activeChip={activeChip} query={query} />
        ) : (
          <DefaultLayout totalGuides={totalGuides} />
        )}
      </main>
...
function DefaultLayout({ totalGuides }: { totalGuides: number }) {
  return (
    <>
      {/* Category tab bar */}
      <div
