  ...
  return (
    <>
      ...
      <main>
        ...
        <TldrBlock
          bullets={[
            <><strong>파우치·필름 선택은 내용물 기체 차단 요건이 핵심</strong> — 산소 차단(OTR)·수분 차단(WVTR) 수치를 먼저 정의합니다.</>,
            <><strong>알루미늄 라미네이트 = 최고 차단성</strong> — 커피·분말 식품 장기 보관에 최적, 단가는 PE 필름 대비 3~5배 높습니다.</>,
            <><strong>MOQ 3,000~10,000매</strong> — 연포장 생산 특성상 소량 발주는 단가가 급격히 높아집니다.</>,
          ]}
        />

        <CalloutBox variant="info" title="연포장 층 구조 이해">
          연포장 필름은 외층(인쇄·내마모)·중간층(차단)·내층(실링) 3층 구조로 구성됩니다. 차단 요건이 높을수록 중간층에 알루미늄 호일 또는 EVOH를 추가해 층수를 늘립니다. 층수가 늘어날수록 단가와 MOQ가 높아집니다.
        </CalloutBox>
        <CalloutBox variant="warn" title="식품 용도 내층 소재 법적 요건">
          식품에 직접 접촉하는 내층 소재는 식약처 기준을 충족해야 합니다. PE·PP·PET 중에서도 등급·규격에 따라 허용 여부가 다르므로 발주 전 업체에 식품 접촉 이행성 시험 성적서를 반드시 요청하세요.
        </CalloutBox>
        <CalloutBox variant="tip" title="파일럿 롤 선발주 권장">
          연포장은 필름 표면 특성·인쇄 색상이 실제 생산에서 달라질 수 있습니다. 본 발주 전 소량 파일럿 롤(200~500m)로 인쇄 품질·밀봉 강도를 검수하면 대량 불량 리스크를 줄일 수 있습니다.
        </CalloutBox>

        <ChecklistCard
          heading="연포장 발주 전 확정 항목"
          items={[
        ...
        <FaqSlot
          items={[
            {
              q: "파우치와 비닐 봉지의 차이는 무엇인가요?",
              a: "파우치는 복합 필름(2층 이상 라미네이트) 구조로 내용물 보호·차단 성능이 높고, 지퍼락·이지필 등 기능성 개봉 구조를 추가할 수 있습니다. 비닐 봉지는 단층 또는 2층 PE 필름으로 내용물 보호 기능이 낮지만 단가가 훨씬 저렴합니다.",
            },
            {
              q: "연포장 MOQ는 얼마나 되나요?",
              a: <>그라비아 인쇄 기준 3,000~10,000매가 일반적입니다. 무지(白) 또는 디지털 인쇄 방식을 사용하면 500~1,000매 소량 발주가 가능하지만 단가는 높아집니다. 소량 발주 옵션은 <Link href="/guides/small-quantity-custom-box">소량 맞춤 박스 가이드</Link>를 참고하세요.</>,
            },
            {
              q: "커피·분말 제품 장기 보관에 적합한 파우치 소재는 무엇인가요?",
              a: "알루미늄 라미네이트(AL/PET/PE 구조)가 산소·수분·광선 차단 성능이 가장 높아 장기 보관에 적합합니다. 단가는 PE 단층 필름 대비 3~5배 높지만 유효기간 연장 효과로 총비용을 줄일 수 있습니다.",
            },
            {
              q: "친환경 연포장 소재로 전환할 수 있나요?",
              a: <>GRS 인증 재생 PE·PP 필름이나 PLA·PBAT 혼합 생분해 필름으로 전환이 가능합니다. 단, 생분해 필름은 차단 성능이 일반 필름보다 낮고 MOQ·납기가 길어질 수 있습니다. 친환경 소재 전환 기준은 <Link href="/guides/eco-friendly-packaging">친환경 포장재 가이드</Link>를 참고하세요.</>,
            },
            {
              q: "연포장 그라비아 인쇄 형판비는 얼마나 드나요?",
              a: <>색상당 30~80만 원이 일반적이며, 8도 풀컬러 기준 240~640만 원입니다. 형판은 동일 소재·색상 재주문 시 재사용 가능합니다. 인쇄 비용 절감 방법은 <Link href="/guides/packaging-printing-guide">포장 인쇄 가이드</Link>를 참고하세요.</>,
            },
          ]}
        />
        ...
        <SidebarGuides
          guides={[
            { href: "/guides/packaging-material-complete-guide", label: "골판지·단프라·연포장 소재 종합 비교", readTime: "⏱ 6분" },
            { href: "/guides/eco-friendly-packaging", label: "FSC·GRS·생분해 인증 소재 전환 가이드", readTime: "⏱ 6분" },
            { href: "/guides/food-packaging-materials", label: "식품 포장재 위생·식약처 기준", readTime: "⏱ 5분" },
            { href: "/guides/packaging-printing-guide", label: "그라비아·플렉소·디지털 인쇄 비교", readTime: "⏱ 5분" },
          ]}
        />

        <EndCta
          title="연포장 파우치 업체 바로 비교"
          subtitle="파우치·필름 전문 업체, 소재·차단 규격·MOQ로 필터 비교"
          href="/products/film"
        />
      </main>
    </>
