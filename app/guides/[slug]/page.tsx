...
const SLOT_DATA_TAPE_COMPARISON: SlotData = {
  ...
  sidebar: {
    ...
    ctaSubtext: "Packlinx에서 OPP·크라프트·무소음 테이프 공급사를 비교하세요.",
    ctaButtonLabel: "업체 비교하기 →",
    ctaHref: "/products/packaging-tape",
    relatedGuides: [
      { href: "/guides/packaging-accessories-guide", title: "포장 부자재 가이드", readTime: "5분" },
      { href: "/guides/이사박스-대량구매-가이드", title: "이사박스 대량구매", readTime: "4분" },
...
const SLOT_DATA_KOREA_TRENDS_2026: SlotData = {
  heroTag: "트렌드 · 2026 한국 패키징 트렌드",
  heroDateLabel: "2026-05 업데이트",
  heroReadTime: "7분 읽기",
  tldr: [
    {
      bold: "EPR 분담금 체계 변화",
      text: "— 「자원의 절약과 재활용촉진에 관한 법률」에 따라 포장재 생산자책임재활용(EPR) 분담금 산정 방식이 변경됩니다. 정확한 적용 대상·단가·시행일은 한국환경공단 공지를 기준으로 확인하세요.",
    },
    {
      bold: "재생원료 혼입 의무 확대",
  ...
  callouts: [
    ...
    },
    {
      ...
      body: "규제 대응과 별개로 재생원료·생분해 소재로의 전환은 바이어 ESG 요구에도 대응됩니다. 소재별 옵션은 친환경 패키징 가이드(/guides/eco-friendly-packaging)를 참조하세요.",
    },
  ],
  ...
  sidebar: {
    ...
    ctaSubtext: "Packlinx에서 EPR 대응 친환경 패키징 공급사를 비교하세요.",
    ctaButtonLabel: "업체 비교하기 →",
    ctaHref: "/products/eco-friendly-packaging",
    relatedGuides: [
      { href: "/guides/eco-friendly-packaging", title: "친환경 패키징: EPR 규제 대응 친환경 소재 선택", readTime: "6분" },
      { href: "/guides/plastic-container-guide", title: "플라스틱 용기 가이드: 규제 대상 플라스틱 소재 확인", readTime: "5분" },
      { href: "/guides/packaging-material-complete-guide", title: "소재 종합 가이드: 재생원료 혼입 가능 소재 비교", readTime: "7분" },
