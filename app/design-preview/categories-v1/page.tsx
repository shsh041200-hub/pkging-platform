...
export const metadata: Metadata = {
  title: '[Preview] categories-v1 — Packlinx',
  robots: { index: false, follow: false },
}

export default async function CategoriesV1PreviewPage() {
  ...
  // Top 2 vendor names per category for preview chips
  ...
  return (
    <div className="min-h-screen bg-neutral-50 flex flex-col">
      {/* Header — V05 white style (matches main page) */}
      <header className="bg-white sticky top-0 z-50 border-b border-border-v04">
        <div className="max-w-6xl mx-auto px-5 h-14 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-4 text-sm text-neutral-500">
            ...
            <Link
              href="/design-preview/categories-v1"
              aria-current="page"
