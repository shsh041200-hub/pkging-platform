...
**V04 Stripe-inspired · 2026-05-01 · PACAA-139**

이 문서는 packlinx.com의 공식 디자인 시스템입니다. 모든 UI 작업은 이 문서의 규칙을 따릅니다.
...
- Shadow color `rgba(0,55,112,0.08)` for top-edge shadows on sticky elements
...
- Don't use large border-radius (12px+, pill shapes) on cards or buttons — conservative only
...
| Date | Author | Change |
|------|--------|--------|
| 2026-05-01 | CTO | PACAA-139: V03 오렌지 팔레트 → Stripe-inspired 디자인 시스템으로 전면 교체. 퍼플/딥네이비 테마, sohne-var 타이포그래피, 블루틴트 그림자 시스템 도입. |
