...
export const metadata: Metadata = {
  title: '정보 삭제·수정 요청 — 패키징 플랫폼',
  description: '패키징 플랫폼에 등록된 업체 정보의 삭제 또는 수정을 요청하실 수 있습니다.',
}
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="max-w-2xl mx-auto px-4 sm:px-6 py-10 pb-16">
        ...
        <p className="text-sm text-slate-500 mb-8">
          패키징 플랫폼에 등록된 귀사 정보의 삭제 또는 수정을 요청하실 수 있습니다.
        ...
        >
          ...
          <input type="hidden" name="_subject" value="[PKGING] 정보 삭제·수정 요청" />
