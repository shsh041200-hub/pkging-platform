...
import { ProductMobileFilterSheet } from './MobileFilterSheet'

interface ProductFilterBarProps {
  resultCount: number
}

type DropdownKey = 'material' | 'cert'
...
export function ProductFilterBar({ resultCount }: ProductFilterBarProps) {
  ...
  const totalActiveCount = currentMaterials.length + currentCerts.length + (currentSample ? 1 : 0)
