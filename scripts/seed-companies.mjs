...
/** All companies collected via Naver/Google search (KOR-19) */
const companies = [
  // ── 지류 (jiryu) ──────────────────────────────────────────────────────────
  {
    slug: 'box4u-corrugated', name: '박스포유', category: 'jiryu', subcategory: '골판지/택배',
  ...
  {
    slug: 'boxin-package', name: '박스인', category: 'jiryu', subcategory: '인쇄/단상자',
  ...
  {
    slug: 'boxkorea-corrugated', name: '박스코리아', category: 'jiryu', subcategory: '도매/유통',
  ...
  {
    slug: 'boxne-paper-pack', name: '박스네', category: 'jiryu', subcategory: '쇼핑백/맞춤제작',
  ...
  {
    slug: 'boxmga-package', name: '박스명가', category: 'jiryu', subcategory: '프리미엄/화장품',
  ...
  {
    slug: 'boxvill-pack', name: '박스마을', category: 'jiryu', subcategory: '원스톱/부자재',
  ...
  {
    slug: 'boxmoa-corrugated', name: '박스모아', category: 'jiryu', subcategory: '골판지/OEM',
  ...
  {
    slug: 'caseman-package', name: '대흥사', category: 'jiryu', subcategory: '전통/다품목',
  ...
  {
    slug: 'wj-package', name: 'WJ패키지', category: 'jiryu', subcategory: '봉투/쇼핑백',
  ...
  {
    slug: 'pojangland-paper', name: '포장랜드', category: 'jiryu', subcategory: '비닐/봉투',
  ...
  {
    slug: 'seoul-pack-solution', name: '서울포장', category: 'jiryu', subcategory: '포장솔루션',
  ...
  {
    slug: 'chakanpack-eco', name: '착한포장', category: 'jiryu', subcategory: '선물박스/친환경',
  ...
  // ── 식품등급 (food_grade) ──────────────────────────────────────────────────
  {
    slug: 'sunpack-food-container', name: '선팩', category: 'food_grade', subcategory: '일회용기',
  ...
  {
    slug: 'modenpack-food', name: '모든팩', category: 'food_grade', subcategory: '고기능/밀폐',
  ...
  {
    slug: 'yonggiyo-food', name: '용기는요기', category: 'food_grade', subcategory: '카페/배달',
  ...
  {
    slug: 'youlchon-food-pack', name: '율촌화학', category: 'food_grade', subcategory: '연포장/필름',
    description: '국내 대표 연포장 전문 기업. 식품·의약품용 복합 필름 및 파우치 제조 대기업 계열사.',
    province: '경기도', city: '안성시', phone: '031-000-8004',
    email: 'ir@youlchon.com', website: 'https://www.youlchon.com',
    products: ['복합 필름', '진공 파우치', '레토르트 파우치', '스탠딩 파우치'],
    certifications: ['ISO 22000', 'HACCP 인증', 'BRC 인증', 'ISO 9001'], is_verified: true,
  },
  {
    slug: 'packmall-foodpack', name: '포장가게', category: 'food_grade', subcategory: '종합/실링',
  ...
  {
    slug: 'papercups-korea', name: '대한종이컵', category: 'food_grade', subcategory: '종이컵',
  ...
  {
    slug: 'gyeongnam-fresh-food-pack', name: '경남신선팩', category: 'food_grade', subcategory: '신선/냉동',
  ...
  // ── 산업용 (saneobyong) ────────────────────────────────────────────────────
  {
    slug: 'cncairkorea-pack', name: '씨앤씨코리아', category: 'saneobyong', subcategory: '공기완충/에어팩',
  ...
  {
    slug: 'hongjin-pack', name: '홍진포장', category: 'saneobyong', subcategory: '필름/포장지',
  ...
  {
    slug: 'daehung-pojang', name: '대흥포장', category: 'saneobyong', subcategory: '물류/스트레치',
  ...
  {
    slug: 'dongil-aluminum-foil', name: '동일알루미늄', category: 'saneobyong', subcategory: '알루미늄연포장',
  ...
  {
    slug: 'busan-stretch-pack', name: '부산스트레치팩', category: 'saneobyong', subcategory: '물류소모품',
