-- Multi-signal similarity function for company detail page "비슷한 업체" section.
-- Replaces simple first-category match with weighted Jaccard + attribute matching.
-- KOR-530: Legal guardrails (KOR-529) enforced — only whitelisted features used.
--
-- Weights (sum = 1.0):
--   industry_categories Jaccard  0.45
--   category exact match         0.20
--   buyer_category match         0.15
--   packaging_form match         0.10
--   is_verified status match     0.10
